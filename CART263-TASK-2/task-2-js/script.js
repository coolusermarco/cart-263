...
/***OUTPUT: 
 * NodeList(9) [p#1, p#2, p#3, p#4, p#5, p#6, p#7, p#8, p#9]
 */
...
/***OUTPUT: 
 * NodeList(9) [div.inner-container, ...]
 */
...
/***OUTPUT: 
 * <img src="task-2-images/seventeen.png">
 */
...
/***CODE */
const firstPModify = document.querySelector("p");
const todayDate = new Date().toLocaleDateString();

firstPModify.textContent =
